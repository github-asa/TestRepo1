...
namespace J2BIOverseasOps.Pages.BuildingWork.Nearby.GeneralQuestions
{
    internal class NearbyGeneralQPage : BuildingWorkCommon
    {
        ...
        public NearbyGeneralQPage(IWebDriver driver, ILog log, IRunData rundata) : base(driver, log, rundata)
        { }
        ...
        public void EnterNearbyGeneralQAnswers(Table table)
        {
            foreach (var row in table.Rows)
            {
