...
namespace J2BIOverseasOps.Pages.BuildingWork.Nearby.OtherPublicAreas
{
    internal class NearbyOtherPublicAreasPage : BuildingWorkCommon
    {
        ...
        public NearbyOtherPublicAreasPage(IWebDriver driver, ILog log, IRunData runData) : base(driver, log, runData)
        {
