...
namespace J2BIOverseasOps.Pages.BuildingWork.Roadworks.OtherAdvertisedFacilities
{
    internal class RoadworksOtherFacilitiesPage : BuildingWorkCommon
    {
        //other facilities
        ...
        // Buttons  
        private readonly By _removeThisFacility = By.XPath("//p-button[@id='removeThisItem']//button");
        private readonly By _addAnotherFacility = By.XPath("//p-button[@id='addAnotherItem']//button");

        private readonly ApiCalls _apiCall;

        public RoadworksOtherFacilitiesPage(IWebDriver driver, ILog log, IRunData rundata) : base(driver, log, rundata)
        {
        ...
        public void EnterRoadworksOtherFacilitiesAnswers(Table table)
        {
            foreach (var row in table.Rows)
            {
