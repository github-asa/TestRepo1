...
namespace J2BIOverseasOps.Pages.BuildingWork.Roadworks.OverallImpact
{
    internal class RoadworksOverallImpactPage : BuildingWorkCommon
    {
        ...
        public RoadworksOverallImpactPage(IWebDriver driver, ILog log, IRunData rundata) : base(driver, log, rundata)
        { }
